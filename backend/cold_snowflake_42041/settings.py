"""
Django settings for cold_snowflake_42041 project.
...
ROOT_URLCONF = 'cold_snowflake_42041.urls'
...
WSGI_APPLICATION = 'cold_snowflake_42041.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_snowflake_42041 API",
    "DESCRIPTION": "API documentation for cold_snowflake_42041 App",
    "VERSION": "v1",
}

...
## Project Structure
    ...
    ├── cold_snowflake_42041  # Django project configurations
...
1. Clone this repo and `cd cold_snowflake_42041`
...
2. Clone this repo and `cd cold_snowflake_42041`
